...
- [6. Gost 电脑客户端设置](#6-gost-电脑客户端设置)
- [7. Gost 手机端使用](#7-gost-手机端使用)
- [8. 参考](#8-参考)

**前言：本教程来源于 ‣ [^1]的实践经验。此篇教程有一定门槛，读者觉得麻烦可参考笔者的另一篇博文 科学上网之Outline方案[^2]，笔者的 VPS 环境为 Ubuntu 18.04.6 LTS x64，客户端环境为 macOS Ventura 13.0。**
...
- 选择 VPS 提供商。部分参考商家如下[^3]，更多商家请自行网上搜寻，注意仔细甄别商家以避免数据泄漏。千万别用国内提供商的 VPS，容易被监控被抓：
...
**提示：有的商家的 VPS 需要提前开启 22 端口以供终端 SSH 登陆，笔者目前没遇到，读者若遇到还请自行开启。**
...
- 打开终端 Shell 命令行执行 SSH 指令登陆 VPS （Mac 直接打开终端即可，Windows 可下载 XShell、MobaXterm 等工具）。
...
**提示：笔者之前尝试过默认的 443 端口失败，估计被墙，读者的如果没被墙则可沿用默认的443端口。**
...
- 配置好后点击确定回到主菜单。一般情况下建议用 PAC 模式，即勾选 PAC自模式，然后点击“打开Shadowsocks”启动程序。
...
- 替换尖括号部分。用户名和密码和服务端设置的相（如我的是zhangsan）。
...
**后语：苹果手机平板、软路由、数据中心的配置请参考 haoel.github.io[^1]。**

## 8. 参考

[[^1]: https://github.com/haoel/haoel.github.io](https://github.com/haoel/haoel.github.io)

[[^2]: https://meiyingqishi.github.io/科学上网/outline/2022/10/22/科学上网之Outline方案.html](https://meiyingqishi.github.io/%E7%A7%91%E5%AD%A6%E4%B8%8A%E7%BD%91/outline/2022/10/22/%E7%A7%91%E5%AD%A6%E4%B8%8A%E7%BD%91%E4%B9%8BOutline%E6%96%B9%E6%A1%88.html)

[[^3]: https://github.com/haoel/haoel.github.io#2-购买vps](https://github.com/haoel/haoel.github.io#2-%E8%B4%AD%E4%B9%B0vps)

[[^4]: https://v2xtls.org/ssr版shadowsocksx-ng配置教程](https://v2xtls.org/ssr%E7%89%88shadowsocksx-ng%E9%85%8D%E7%BD%AE%E6%95%99%E7%A8%8B/)