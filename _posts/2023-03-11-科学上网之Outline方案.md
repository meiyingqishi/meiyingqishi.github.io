...
![Subject Banner](/assets/images/outline-banner.webp)
...
- 开放管理端口和访问端口，Management port 和 Access key port 后面的数字：
  ...
  ![Outline Port](/assets/images/outline-server-ports.webp)
...
- 复制绿色的字符串粘贴到 Outline Manager 的第二个框即 Paste your installation output here. 下面，并点击 Done 。
  ...
  ![Api Key](/assets/images/outline-server-api-url.webp)

- 点击 Key 后面的分享，复制 2) Copy the following access key. 下面的 ss 链接。

  ![Outline Manager Interface](/assets/images/outline-manager-access-keys.webp)
