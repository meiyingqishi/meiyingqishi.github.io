...
推荐购买美区的 VPS，因为各种可用资源更多限制更少，很多产品和服务都是优先在那试用使用和开服，比如谷歌的 AI 套件，比如如果购买韩国的 VPS 则油管上的一些视频的观看有年龄验证限制，而美区没有。一些站点资源的观看浏览或下载不对亚区开放，访问时会被 Cloudflare 阻止，而美区无限制，比如泥视频、欧乐影院等。如果需要玩及时性和稳定性很高的游戏，那还是老实购买 CN2 GIA、IPLC、IEPL 线路的VPS，或者相关机场吧。总之，最佳实践就是选择美国西海岸的 VPS。
...
- **ClashX 较老，不推荐，软件缺乏更新，主要原因是没有 TUN（虚拟网卡模式，一些海外软件需要这个模式才能正常使用，
比如 Antigravity Desktop，而且有了这个模式，就不需要 6.1.1 了），推荐 [Clash Verge Rev][clash-verge-rev]，如果打不开，可以使用以下链接**。
  - Mac：<https://pan.baidu.com/s/1sbV69DP89BMObXVaaVHRLg> 提取码: idv2
  - Windows：<https://www.alipan.com/s/9xwjtMFK6BH> 提取码: 85gb

- 下载并安装 [ClashX](https://github.com/MetaCubeX/ClashX.Meta/releases)。

- 右键 Mac 右上角状态栏中的 ClashX 的 🐱 图标，依次选择 配置 -> 打开配置文件夹。

  ![ClashX drop down menu list](/assets/images/ClashXDropDownMenuList.webp)
...
- 下载并安装 [Clash Verge Rev][clash-verge-rev]。

- 余后步骤类似，大同小异，自己探索，由于笔者暂无 Windows 电脑，暂不方便展开后续步骤。
...
- 下载并安装 [Clash for Android](https://github.com/MetaCubeX/ClashMetaForAndroid/releases)。
  ...
  ![Clash4Android homepage](/assets/images/clash4android-homepage.webp)
